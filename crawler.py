...
class Crawler:
    def __init__(self, movies_to_parse, path_url):
        ...
        self.columns = ['title', 'genre', 'year', 'certificate', 'runtime', 'user-votes', 'imdb-scores',
                        'metacritic-scores', 'descriptions', 'stars']
    ...
    def get_dataset(self):
        ...
        data = pd.concat(
            [data_titles, data_genres, data_years, data_certificates, data_runtimes, data_votes, data_imdb_scores,
             data_metacritic_scores, data_descriptions,
